...
using Legionite.Infrastructure.Common.Extensions;
using Legionite.Infrastructure.Common.Hangfire.Filters;
using Legionite.Infrastructure.Common.Seeder.Services;
using Legionite.Infrastructure.Common.Settings.Services;
using Legionite.Infrastructure.Common.Templates;
using Legionite.Infrastructure.Common.Templates.Services;
using Legionite.Infrastructure.Identity.Services;
using Legionite.Web.Jobs;

namespace Legionite.Web;
...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        {
            c.SwaggerDoc("v1", new OpenApiInfo { Title = "Legionite.Web API", Version = "v1" });
